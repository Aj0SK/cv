...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Bachelor of Science in Computer Science;  GPA: TODO}{Aug. 2017 -- Dec. 2020}
      \resumeItemListStart
        \resumeItem{}
          {Took many interesting courses including Algorithms and data structures, System programming, Database programming, Computer networks but also Mathematical analysis, Algebra, Probability and statistics.}
         \resumeItem{}
          {Thesis in DNA sequencing for bioinformatics applications.}
         \resumeItem{}
          {assistent on C++ course since Sept. 2019}
      \resumeItemListEnd
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheadingMY
     ...
     \resumeSubheadingMY
      ...
      \resumeItemListStart
        \resumeItem{}
          {My work in HighChem was important part of presented work as a problem that I solved blocked it for a long time.}
      \resumeItemListEnd
